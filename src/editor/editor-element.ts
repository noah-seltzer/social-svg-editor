...
export class CanvasObjectWrapper<T extends fabric.Object> {
  constructor(obj: T) {
  }
...
const obj = new CanvasObjectWrapper(new fabric.Line())


export const SnappyRect = fabric.util.createClass(fabric.Rect, {
  type: "snappyRect",

  initialize: function(options: fabric.IObjectOptions | undefined) {
    options || (options = {});
